...
class Business(db.Model):
    ...
    # Physical receipt roll width. Used to size the bitmap the print-agent rasterizes
    # (see app/static/js/print-client.js) and the browser-print fallback's page width.
